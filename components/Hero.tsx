...
const Hero: React.FC = () => {
  return (
    <div className="relative min-h-screen flex flex-col justify-center pt-20 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 lg:px-24">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          ...
          <div className="lg:col-span-7 pt-12">
            ...
            <h1 className="text-6xl md:text-[5.5rem] font-bold tracking-tighter leading-[0.9] mb-8">
              The Architecture of <br/>
              <span className="text-white/30 italic font-light">Sovereign Growth.</span>
            </h1>

            <div className="max-w-xl space-y-8">
              <p className="text-xl md:text-2xl text-white/60 leading-tight font-medium">
              ...
              <div className="flex flex-wrap gap-6 items-center pt-4">
                ...
                <div className="flex flex-col">
                  ...
                  <a href="#" className="text-[11px] font-mono text-white/60 hover:text-white transition-colors border-b border-white/10 pb-1">View Case Studies</a>
                </div>
              </div>
            </div>

            {/* Direct Win / Business Outcomes */}
            <div className="mt-16 grid grid-cols-2 md:grid-cols-3 gap-12 border-t border-white/5 pt-12 max-w-2xl">
               <div>
          ...
          <div className="lg:col-span-5 relative">
            ...
            <div className="mt-12 lg:mt-0 lg:absolute lg:-bottom-24 lg:-right-12 glass-panel p-6 w-full lg:w-80 space-y-4">
      ...
      {/* Bottom Interface */}
      <div className="absolute bottom-10 left-10 right-10 flex justify-between items-end border-t border-white/5 pt-8">

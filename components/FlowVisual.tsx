    ...
    <div className="relative w-full max-w-[440px] aspect-square">
      ...
      <svg viewBox="0 0 500 500" className="w-full h-full relative z-10 filter drop-shadow-[0_0_20px_rgba(57,255,20,0.1)]">
        ...
        <g className="node" transform="translate(420, 250)">
          ...
          <text y="42" textAnchor="middle" fill="white" fontSize="7" fontFamily="JetBrains Mono" className="uppercase opacity-40">UCP Protocol</text>
        </g>
        ...
        <g className="node" transform="translate(80, 250)">
          ...
          <text y="42" textAnchor="middle" fill="white" fontSize="7" fontFamily="JetBrains Mono" className="uppercase opacity-40">GenAI.Opt</text>
        </g>
